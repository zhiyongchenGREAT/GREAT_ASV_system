...
from loss.SBM import Center_AM_softmax
...
class SpeakerNet(nn.Module):
    ...
    def __init__(self, model, optimizer, trainfunc, nPerSpeaker, Syncbatch=False, **kwargs):
        ...
        # self.SBM = FOCAL_ALDA_MULDO_OPT_FAST(spk_clf_head=self.__L__, spk_backbone=self.__S__, **kwargs)
        self.SBM = Center_AM_softmax(SBM_k=200, **kwargs)
    ...
    def forward(self, data, label=None):
        ...
        if label == None:
            ...
            nloss, prec1 = self.SBM.forward(outps, label)
