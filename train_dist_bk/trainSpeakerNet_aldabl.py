...
parser.add_argument('--fitlog_Desc',    type=str,   default="xvector_bl_0.01");
parser.add_argument('--train_name',     type=str,   default="xvector_bl_0.01");
