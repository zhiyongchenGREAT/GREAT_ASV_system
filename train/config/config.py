...
print(1)
class Config(object):
    train_name = "small mix 1L AL weight4"
    description = 'small mix 1L AL weight step every, <0.6 add gamma, with D class weight 5'
    model = ''
    model_settings = {'in_feat': 30, 'emb_size': 512, 'class_num': 1311, \
    's': 50, 'm': 0.2, 'anneal_steps': 1000, 'weight': 5}
