...
if __name__ == '__main__':
    ...
    train_dataloader = DataLoader(dataset=train_data, batch_size = opt.train_batch_size, sampler=WithReplacementRandomSampler(train_data), shuffle = False, num_workers = opt.num_workers, pin_memory=False)
