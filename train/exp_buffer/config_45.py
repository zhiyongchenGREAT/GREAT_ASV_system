...
print(1)
class Config(object):
    train_name = "small mix 1L AL FOCAL_Balance1_12"
    description = 'small mix 1L AL Focal step every, no ctrl gamma, gamma 1.0 beta 1.0 fixed, with D class weight 12 rebalanced FOCAL, \
