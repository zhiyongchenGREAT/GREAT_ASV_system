...
print(1)
class Config(object):
    train_name = "small mix 1L AL weight27_1(19)"
    description = 'small mix 1L AL weight step every, no ctrl gamma, gamma 0.1 beta 0.025 fixed, with D class weight 6, \
    long dur, ch adv and rebanlance adv class, change to minc lr decay base on vox, f_d 0 f_al 0, simulate weight19 again, monitor tranlossal'
    model = ''
