...
def main():
    ...
    while True:
        ...
        train_loss += loss_c.item()/opt.print_freq
        ...
        opt_c.zero_grad()
        opt_d.zero_grad()
        beta = min((total_step / 10000), 1.0)*beta_scale
        ...
        opt_c.zero_grad()
        opt_d.zero_grad()
        gamma = min((total_step / 10000), 1.0)*gamma_scale
        ...
        if (total_step % opt.print_freq) == 0:
            ...
            training_utils.standard_freq_logging(delta_time, total_step, train_loss, train_acc, opt_e, train_log, tbx_writer)
