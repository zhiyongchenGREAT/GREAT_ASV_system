...
print(1)
class Config(object):
    train_name = "small mix 1L AL FOCAL_Balance1_13"
    ...
    long dur, ch adv and rebanlance adv class, change to minc lr decay base on vox, f_d 1 f_al 1'
    model = ''
    model_settings = {'in_feat': 30, 'emb_size': 512, 'class_num': 1311, \
    's': 50, 'm': 0.2, 'anneal_steps': 1000, 'weight': 12, 'focal_d_gamma': 1, 'focal_al_gamma': 1}
    metric = ''
    max_step = 1000000
