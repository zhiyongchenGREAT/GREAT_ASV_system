...
print(1)
class Config(object):
    train_name = "small mix 1L AL FOCAL_Balance_debug"
    ...
    long dur, ch adv and rebanlance adv class, change to minc lr decay base on vox, f_d 0 f_al 0, set rebalance to 128 and w to 6 to debug'
    model = ''
