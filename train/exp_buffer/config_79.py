...
print(1)
class Config(object):
    train_name = "small 100 mix 1L pure balanGAN longer"
    description = 'small 100 mix 1L pure balanGAN longer, 2000 intval'
    model = 'Xvector_SAP_1L'
    model_settings = {'in_feat': 30, 'emb_size': 512, 'class_num': 1311, \
    's': 50, 'm': 0.2, 'anneal_steps': 1000}
    metric = 'AM_normfree_softmax_anneal_ce_SycnBN'
    max_step = 1000000
