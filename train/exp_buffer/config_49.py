...
print(1)
class Config(object):
    train_name = "small mix 1L AL FOCAL_Balance1_16"
    description = 'small mix 1L AL Focal step every, no ctrl gamma, gamma 0.2 beta 0.05 fixed, with D class weight 12 rebalanced FOCAL, \
