...
print(1)
class Config(object):
    train_name = "full mix 1L w-ALDA"
    description = 'full mix 1L AL Focal step every, no ctrl gamma, gamma 0.1 beta 0.1 fixed, with D class weight 8, \
    ch adv and rebanlance adv class, change to minc lr decay base on vox'
    model = ''
    model_settings = {'in_feat': 30, 'emb_size': 512, 'class_num': 7811, \
    's': 50, 'm': 0.2, 'anneal_steps': 10000, 'weight': 8}
    metric = ''
    max_step = 1000000
    ...
    # train_list = '/Lun0/zhiyong/dataset/tmp_data_csv.csv'
