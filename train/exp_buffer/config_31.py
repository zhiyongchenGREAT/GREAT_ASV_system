...
print(1)
class Config(object):
    train_name = "small mix 1L AL FOCAL5"
    description = 'small mix 1L AL Focal step every, no ctrl gamma, gamma 0.1 beta 0.025 fixed, with D class weight 6, \
    long dur, ch adv and rebanlance adv class, change to minc lr decay base on vox, f_d 2 f_al 3'
    model = ''
    model_settings = {'in_feat': 30, 'emb_size': 512, 'class_num': 1311, \
    's': 50, 'm': 0.2, 'anneal_steps': 1000, 'weight': 6, 'focal_d_gamma': 2, 'focal_al_gamma': 3}
