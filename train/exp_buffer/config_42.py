...
print(1)
class Config(object):
    train_name = "small mix 1L AL FOCAL_Balance1_9"
    description = 'small mix 1L AL Focal step every, no ctrl gamma, gamma 0.1 beta 0.5 fixed, with D class weight 12 rebalanced FOCAL, \
