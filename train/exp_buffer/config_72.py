...
print(1)
class Config(object):
    train_name = "full mix 1L FOCAL_ALDA_OPT e_lr2"
    description = 'full mix 1L FOCAL_ALDA_OPT, gamma 0.1 beta 0.1 fixed, class weight 12, \
    long dur, lr decay base on epoch step, f_d 0 f_al 0'
    model = ''
