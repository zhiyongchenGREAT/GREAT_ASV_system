...
print(1)
class Config(object):
    train_name = "small mix 1L AL weight17"
    description = 'small mix 1L AL weight step every, no ctrl gamma, gamma 0.2 beta 0.2 fixed, with D class weight 6, long dur, ch adv'
    model = ''
