...
parser.add_argument('--train_list',     type=str,   default="/workspace/DATASET/server9_ssd/sdsv21/sdsv21_DA_10960.txt",     help='Train list')
...
parser.add_argument('--ori_weight_dict',  type=json.loads,   default='{"0":"6", "1":"1"}')
...
parser.add_argument('--fitlog_Desc',    type=str,   default="ECAPA-1024+DAT+(sdsv/mozila)");
parser.add_argument('--train_name',     type=str,   default="ECAPA-1024+DAT+(sdsv/mozila)");
