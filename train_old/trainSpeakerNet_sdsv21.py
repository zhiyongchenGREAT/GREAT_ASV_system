...
parser.add_argument('--expected_step',  type=int, default=int(520000*1.3*3),  help='Total steps')
...
parser.add_argument('--nClasses',       type=int,   default=10960*3,   help='Number of speakers in the softmax layer, only for softmax-based losses')
...
parser.add_argument('--train_list',     type=str,   default="/workspace/DATASET/server9_ssd/sdsv21/sdsv21_pretrain_10960.txt",     help='Train list')
...
parser.add_argument('--fitlog_DATASET', type=str,   default="otf_sdsv21full")
parser.add_argument('--fitlog_Desc',    type=str,   default="sdsv21_full_pretrain")
parser.add_argument('--train_name',     type=str,   default="sdsv21_full_pretrain")
parser.add_argument('--mixedprec',      dest='mixedprec',   action='store_true', help='Enable mixed precision training')
parser.add_argument('--GPU',            type=str,   default="0, 1, 5, 6")
