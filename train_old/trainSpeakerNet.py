...
parser.add_argument('--fitlog_DATASET', type=str,   default="otf_sdsv21")
parser.add_argument('--fitlog_Desc',    type=str,   default="ECAPA-TDNNL(vox2)")
parser.add_argument('--train_name',     type=str,   default="ECAPA-TDNNL(vox2)")
