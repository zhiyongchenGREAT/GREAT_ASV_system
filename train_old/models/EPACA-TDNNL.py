...
class ECAPA_TDNN(nn.Module):
    def __init__(self, in_channels=40, channels=512, embd_dim=192, spec_aug=False):
        super().__init__()
...
def MainModel(n_mels, nOut, spec_aug, **kwargs):
    model = ECAPA_TDNN(in_channels=n_mels, channels=512, embd_dim=nOut, spec_aug=spec_aug)
    return model
