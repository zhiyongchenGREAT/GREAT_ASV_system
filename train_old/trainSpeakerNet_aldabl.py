...
parser.add_argument('--nClasses',       type=int,   default=10960,   help='Number of speakers in the softmax layer, only for softmax-based losses');
...
parser.add_argument('--train_list_0',     type=str,   default="/workspace/DATASET/server9_ssd/sdsv21/sdsv21_DA_EN9543.txt",     help='Train list 0')
parser.add_argument('--train_list_1',     type=str,   default="/workspace/DATASET/server9_ssd/sdsv21/sdsv21_DA_FA1417.txt",     help='Train list 1')
...
parser.add_argument('--test_list_sdsv',      type=str,   default="/workspace/DATASET/server9_ssd/sdsv21/task2_testtriallist.txt", help='Absolute path to the sdsv test set')
...
parser.add_argument('--domain_imbalance_ratio',  type=json.loads,   default='{"0":"1", "1":"7"}')
...
parser.add_argument('--fitlog_DATASET', type=str,   default="sdsv21");
parser.add_argument('--fitlog_Desc',    type=str,   default="ECAPA-1024+BLDAT+(sdsv/mozila)");
parser.add_argument('--train_name',     type=str,   default="ECAPA-1024+BLDAT+(sdsv/mozila)");
