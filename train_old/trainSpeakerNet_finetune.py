...
parser.add_argument('--margin',         type=float, default=0.0,      help='Loss margin, only for some loss functions');
...
parser.add_argument('--fitlog_Desc',    type=str,   default="epacaltune_smaller_m0.0");
parser.add_argument('--train_name',     type=str,   default="epacaltune_smaller_m0.0");
