...
parser.add_argument('--nClasses',       type=int,   default=6114,   help='Number of speakers in the softmax layer, only for softmax-based losses')
...
parser.add_argument('--ori_weight_dict',  type=json.loads,   default='{"0":"30", "1":"1"}')
...
parser.add_argument('--fitlog_Desc',    type=str,   default="ECAPA-TDNNLmixdataDAT+sidetune0.9(vox2+ffsvc)")
parser.add_argument('--train_name',     type=str,   default="ECAPA-TDNNLmixdataDAT+sidetune0.9(vox2+ffsvc)")
