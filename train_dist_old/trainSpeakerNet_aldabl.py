...
parser.add_argument('--nClasses',       type=int,   default=6582,   help='Number of speakers in the softmax layer, only for softmax-based losses');
...
parser.add_argument('--train_list_0',     type=str,   default="/workspace/DATASET/server9_ssd/sdsv21/vox2_5994DAtrainlist.txt",     help='Train list 0')
parser.add_argument('--train_list_1',     type=str,   default="/workspace/DATASET/server9_ssd/sdsv21/sdsv_588DAtrainlist.txt",     help='Train list 1')
...
parser.add_argument('--domain_imbalance_ratio',  type=json.loads,   default='{"0":"1", "1":"11"}')
...
parser.add_argument('--fitlog_DATASET', type=str,   default="vox_sdsv21");
parser.add_argument('--fitlog_Desc',    type=str,   default="ECAPA-TDNNLmixdatabalancetune(vox2+sdsv)");
parser.add_argument('--train_name',     type=str,   default="ECAPA-TDNNLmixdatabalancetune(vox2+sdsv)");
