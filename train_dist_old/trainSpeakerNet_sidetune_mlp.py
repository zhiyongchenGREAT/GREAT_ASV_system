...
from SpeakerNet_sidetune_mlp import *
...
parser.add_argument('--fitlog_Desc',    type=str,   default="ECAPA-TDNNLMLPa=BEST")
parser.add_argument('--train_name',     type=str,   default="ECAPA-TDNNLMLPa=BEST")
