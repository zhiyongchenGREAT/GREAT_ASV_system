...
from SpeakerNet_sidetune_aldabl import *
...
parser.add_argument('--train_list_0',     type=str,   default="/workspace/DATASET/server9_ssd/ffsvc/trainlist_vox5994DA.txt",     help='Train list 0')
parser.add_argument('--train_list_1',     type=str,   default="/workspace/DATASET/server9_ssd/ffsvc/trainlist_ffsvc120DA.txt",     help='Train list 1')
...
parser.add_argument('--sox_aug_target',       type=bool,  default=True,    help='Use sox aug or not');
...
parser.add_argument('--domain_imbalance_ratio',  type=json.loads,   default='{"0":"1", "1":"50"}')
...
parser.add_argument('--fitlog_DATASET', type=str,   default="vox2_ffsvc")
parser.add_argument('--fitlog_Desc',    type=str,   default="ECAPA-TDNNLmixdatabalancesidetunesox0.9(vox2+ffsvc)")
parser.add_argument('--train_name',     type=str,   default="ECAPA-TDNNLmixdatabalancesidetunesox0.9(vox2+ffsvc)")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    trainLoader_do1 = get_data_loader_alda(args.train_list_1, batch_size=(args.batch_size//args.domain_classes),\
                        ...
                        class_strict_balance=True, sox_aug=args.sox_aug_target, **dataloader_args)
