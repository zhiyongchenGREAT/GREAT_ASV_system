...
parser.add_argument('--fitlog_Desc',    type=str,   default="adaBN_0.001_m0.0")
parser.add_argument('--train_name',     type=str,   default="adaBN_0.001_m0.0")
